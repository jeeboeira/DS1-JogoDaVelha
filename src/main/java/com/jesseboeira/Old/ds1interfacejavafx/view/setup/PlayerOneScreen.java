package com.jesseboeira.Old.ds1interfacejavafx.view.setup;

import com.jesseboeira.Old.ds1interfacejavafx.controller.LocalGameSetupController;
...
public class PlayerOneScreen implements Screen {
    ...
    public void show(Stage stage) {
        ...
        String backgroundPath = "/assets/images/playersBackground.png";
    ...
    private VBox createEnterNameTitle() {
        ...
        String imgNamePath = "/assets/images/enterYourName.png";
    ...
    private VBox createChooseSideTitle() {
        ...
        String imgTeamPath = "/assets/images/choseYourSide.png";
    ...
    private HBox createTeamSelection() {
        ...
        String imgX = "/assets/images/ButtonX.png";
        String imgO = "/assets/images/ButtonO.png";
    ...
    private VBox createNextButton(VBox nameFieldBox, HBox teamGroupBox) {
        ...
        String imgNextPath = "/assets/images/next.png";
